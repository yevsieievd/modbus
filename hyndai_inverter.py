...
class HyndaiInverter( abstract_driver.AbstractDriver ):
    ...
    def set_friq(self, value):
        ...
        try:
            self.write_register(0x0004, int(value*100), numberOfDecimals=0, functioncode=6, signed=False) > 0
        except (IOError, ValueError, TypeError):
            pass
    ...
    def stop(self):
        """Stop."""
        try:
            self.write_register(0x0002, 0x0000, numberOfDecimals=0, functioncode=6, signed=False) > 0
        except (IOError, ValueError, TypeError):
            pass
    ...
    def run_fwd(self):
        """Run forward."""
        try:
            self.write_register(0x0002, 0x0001, numberOfDecimals=0, functioncode=6, signed=False)
        except (IOError, ValueError, TypeError):
            pass
    ...
    def run_rev(self):
        """Run revers"""
        try:
            self.write_register(0x0002, 0x0002, numberOfDecimals=0, functioncode=6, signed=False) > 0
        except (IOError, ValueError, TypeError):
            pass
    ...
    def reset(self):
        """"""
        try:
            self.write_register(0x0002, 0x0004, numberOfDecimals=0, functioncode=6, signed=False) > 0
        except (IOError, ValueError, TypeError):
            pass
